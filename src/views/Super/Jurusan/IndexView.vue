  ...
  <DefaultLayoutAdmin>
            ...
            <tr v-for="(jurusan, index) in jurusanData" :key="index">
              ...
              <td class="py-5 px-4">
                <div class="flex items-center space-x-3.5">
                  <button
                    @click="$router.push({ name: 'jurusan.update', params: { id: jurusan.id } })"
                  ...
                  <button @click="() => { itemToDelete = jurusan; showModal = true; }"
                   class="hover:text-primary">
                   <svg
                      class="fill-current"
                      width="18"
    ...
    <div v-if="showModal" class="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center">
      <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
        ...
        <p class="text-center mb-4">Apakah Anda yakin ingin menghapus jurusan ini?</p>
