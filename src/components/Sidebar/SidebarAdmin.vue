...
const menuGroups = ref([
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: '#',
        children: [
          { label: 'Jenis Barang', route: '/admin/dashboard/jenis-barang' },
          { label: 'Daftar Pengguna', route: '/admin/dashboard/daftar-pengguna' },
          { label: 'Kelas', route: '/admin/dashboard/kelas' },
          { label: 'Jurusan', route: '/admin/dashboard/jurusan' },
          { label: 'Vendor', route: '/admin/dashboard/vendor' },
        ]
      },
