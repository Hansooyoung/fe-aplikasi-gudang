...
<template>
  <!-- ====== Forms Section Start -->
  <div
    class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark min-h-svh flex items-center"
  >
      ...
      <div class="hidden w-full xl:block xl:w-1/2">
        <div class="py-17.5 px-26 text-center">
          ...
          <p class="font-medium 2xl:px-20">
            Aplikasi Barang Inventaris adalah solusi digital untuk mengelola inventaris barang dengan efisien dan mudah.
          </p>
